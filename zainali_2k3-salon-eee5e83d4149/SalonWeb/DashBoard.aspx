<%@ Page Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeBehind="DashBoard.aspx.cs" Inherits="SalonWeb.DashBoard" %>
                        ...
                        <div class="card-body textcolor">
                            <div class="media d-flex">
                                <div class="media-body text-left">
                                    <h3 class="info">
                                        <asp:Label ID="lblAppointments" runat="server" Text="" CssClass="info"></asp:Label></h3>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="media d-flex">
                                <div class="media-body text-left">
                                    <h3 class="warning">
                                        <asp:Label ID="lblProfit" runat="server" Text="" CssClass="warning"></asp:Label></h3>
                                    <h6>Net Profit</h6>
                                </div>
                                <div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="media d-flex">
                                <div class="media-body text-left">
                                    <h3 class="success">
                                        <asp:Label ID="lblIncome" runat="server" Text="" CssClass="success"></asp:Label></h3>
