<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginCustomer.aspx.cs" Inherits="SalonWeb.LoginCustomer" %>
                            ...
                            <div class="card border-lighten-3 m-0 cardborder">
                                <div class="card-header border-1 cardborder" style="border-radius:25px;">
                                    <div class="card-title text-center cardborder">
                                        <div class="p-1">
                                            <img src="../../../app-assets/images/logo.png" alt="Appointment Management System" style="max-height:170px; max-width:150px;">
                                            <br />
                                                <br />
                                                 <h1 style="color:white; font-weight:bold;">Welcome Back!</h1>
                                                  <p style="color:white;">Login to your existant Account</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal form-simple" action="#" novalidate runat="server">
                                            <fieldset class="form-group position-relative has-icon-left mb-0">
                                                <asp:TextBox ID="txtPhone" runat="server" CssClass="form-control form-control-lg input-lg" placeholder="Phone Number" TextMode="phone" required></asp:TextBox>
                                            ...
                                            <div class="form-actions center">
                                                <asp:Button ID="btnSubmit" runat="server" class="btn darkbg" Text="Login" style="width:150px" OnClick="btnSubmit_Click" />
